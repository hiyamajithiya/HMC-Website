          ...
          <body>
            ...
            <div class="content">
              ...
              <div class="field">
                ...
                <div class="value">
                  <a href="mailto:${email}" style="color: #1a365d; text-decoration: none;">${email}</a>
                </div>
              </div>
        ...
        <html>
          ...
          <body>
            ...
            <div class="content">
              ...
              <p>Best regards,<br>
              <strong>${SITE_INFO.proprietor}</strong><br>
              ${SITE_INFO.name}<br>
              ICAI Membership: ${SITE_INFO.icaiMembership}</p>

              <div class="footer">
                <p>This is an automated confirmation email. Please do not reply to this email.</p>
                <p>${SITE_INFO.address.line1}, ${SITE_INFO.address.line2}<br>
                ${SITE_INFO.address.city}, ${SITE_INFO.address.state} - ${SITE_INFO.address.pincode}</p>
              </div>
            </div>
          </body>
        </html>
